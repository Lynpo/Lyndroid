...
public class CircleProgressBar extends View {
    ...
    private int color = ContextCompat.getColor(getContext(), R.color.color_2c64bd);
    private int colorBackground = ContextCompat.getColor(getContext(), R.color.color_ebebeb);
    private RectF rectF;
