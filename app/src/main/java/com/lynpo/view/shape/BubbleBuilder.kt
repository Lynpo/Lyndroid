 ...
 */
class BubbleBuilder private constructor() {
    ...
    class Builder(private val mContext: Context, private val direction: DuiConfigs.Direction = DuiConfigs.Direction.DOWN) {
        ...
        fun buildInto(view: ViewGroup) = buildInto(
            view,
            ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)
        )

        fun buildInto(containerView: ViewGroup, layoutParams: ViewGroup.LayoutParams) {
            ...
            containerView.addView(ConstraintLayout(mContext).apply {
