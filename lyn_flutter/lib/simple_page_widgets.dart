...
import 'package:lyn_flutter/platform_view.dart';
  ...
  Future<bool> _onWillPop() async {
    ...
    return (await showDialog(
        ...
        builder: (context) => new AlertDialog(
          title: new Text("Sure to exit?"),
          content: new Text("Sure To exit app ?"),
          actions: <Widget>[
            new FlatButton(onPressed: () => Navigator.of(context).pop(false), child: new Text("NO")),
            new FlatButton(onPressed: () => Navigator.of(context).pop(true), child: new Text("YES")),
          ],
        ))) ?? false;
  }
*/
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                ...
                /// 例如：sample://nativePage?aaa=bbb
                onTap: () {
                  print("on open tab taped.");
                  return FlutterBoost.singleton.open(
                  'tab',
                  urlParams: <String, dynamic>{
                    'query': <String, dynamic>{'aaa': 'bbb'}
                  },
